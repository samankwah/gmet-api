"""
WORKING IMPORT SCRIPT - Using raw aiosqlite for parameter binding
...
async def working_import():
    print("=" * 80)
    print("DATA IMPORT - 2024-2025")
    print("=" * 80)
        ...
        for (station_code, year, month), group in grouped:
            ...
            for day, data in days_data.items():
                try:
                    ...
                    vals = [station_id, obs_dt.isoformat()]
                    ...
                    await db.execute(
                        f"INSERT OR IGNORE INTO synoptic_observations ({col_list}) VALUES ({placeholders})",
                        vals
                    )
                    imported += 1
